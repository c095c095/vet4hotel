...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo assets('favicon-admin/favicon-96x96.png'); ?>" sizes="96x96" />
    <link rel="icon" type="image/svg+xml" href="<?php echo assets('favicon-admin/favicon.svg'); ?>" />
    <link rel="shortcut icon" href="<?php echo assets('favicon-admin/favicon.ico'); ?>" />
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo assets('favicon-admin/apple-touch-icon.png'); ?>" />
    <link rel="manifest" href="<?php echo assets('favicon-admin/site.webmanifest'); ?>" />
